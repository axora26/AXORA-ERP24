...
import { BIM_PERMISSIONS as BIM, COMMISSIONING_PERMISSIONS as CX, DOCUMENTS_PERMISSIONS as D, FIELD_PERMISSIONS as F, QHSE_PERMISSIONS as Q } from "@axora24/contracts";
...
export class FilesController {
  ...
  @Post()
  @RequireAnyPermission(D.FILE_UPLOAD, F.EVIDENCE_CREATE, D.DOCUMENT_MANAGE, Q.INSPECTION_MANAGE, Q.ACTION_MANAGE, CX.MANAGE, BIM.MODEL_MANAGE)
  ...
  @Get(":id")
  @RequireAnyPermission(D.DOCUMENT_READ, F.SITE_READ, Q.READ, CX.READ, BIM.MODEL_READ)
