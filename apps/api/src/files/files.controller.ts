...
import { DOCUMENTS_PERMISSIONS as D, FIELD_PERMISSIONS as F } from "@axora24/contracts";
...
export class FilesController {
  ...
  @Post()
  @RequireAnyPermission(D.FILE_UPLOAD, F.EVIDENCE_CREATE, D.DOCUMENT_MANAGE)
  ...
  @Get(":id")
  @RequireAnyPermission(D.DOCUMENT_READ, F.SITE_READ)
