 ...
 * testee, ecriture testee. `status` = IMPLEMENTED_NOT_VERIFIED (verifie en
 * local, jamais « TESTED » sans run CI) seulement si aucun systeme externe
 * n'est en jeu ou s'il a ete reellement atteint.
 */
...
export const CONNECTORS: ConnectorEntry[] = [
  ...
  { key: "ifc-import", name: "Import de maquettes IFC", category: "Fichier", supported: true, implemented: true, externalReached: null, readTested: true, writeTested: false, status: "IMPLEMENTED_NOT_VERIFIED", evidence: "Fichiers réels buildingSMART IFC2X3, IFC4 et IFC4X3 lus en test ; export IFC non développé." },
  { key: "energy-csv", name: "Import CSV d'intervalles d'énergie", category: "Fichier", supported: true, implemented: true, externalReached: null, readTested: true, writeTested: null, status: "IMPLEMENTED_NOT_VERIFIED", evidence: "Import idempotent testé en e2e et dans le navigateur." },
