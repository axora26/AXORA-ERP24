...
2026-09-25 — `pnpm typecheck` OK · `pnpm lint` OK · `pnpm test` 58 tests PASS · `pnpm test:e2e` 91 tests PASS (PostgreSQL 16 local) · `nest build` + `next build` OK · ecrans verifies dans Chromium sans erreur console.
